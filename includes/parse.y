...
%token LESSEQUAL LPAR LSQB MINEQUAL MINUS NAME NEWLINE NOT NOTEQUAL INTNUMBER FLOATNUMBER IMAGNUMBER
...
%type<tokenType> augassign pick_unop pick_PLUS_MINUS pick_multop 
%type<intNumber> INTNUMBER 
%type<floatNumber> FLOATNUMBER
%type<str> NAME STRING
%type<node> expr_stmt star_EQUAL pick_yield_expr_testlist yield_expr testlist 
